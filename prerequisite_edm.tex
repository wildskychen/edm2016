...
Then, in \S~\ref{sec:real} we  use  data collected from real students.
	...
	We consider two conditions where different types of $Q$-matrix are used. In the first one,
	...
	Since PARM only discovers pair-wise prerequisite relationship, instead of constructing the full structure,
	...
	These values were also used in the simulation experiments in \cite{chen2015discovering}.
	...
	The ECPE (Examination for the Certification of Proficiency in English).
