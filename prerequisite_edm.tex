...
Modeling prerequisites as edges in a Bayesian network allows us to frame the discovery of prerequisite relationships as the well-studied machine learning problem of learning a DAG (with the presence of latent variables).
...
Then, the input of BNPD is a matrix $\mathbf{D}$ with $n \times p$ dimensions and an item to skill mapping $Q$-matrix.
