...
%The BIC score for a Bayesian network model is composed of a likelihood term and a term to penalize the model complexity.
	...
	With only 500 observations, COMMAND improves on a fully connected Bayesian Network baseline trained with \hl{$n$ ??} observations.
	...
	%For small sample size, this might help because BIC score tends to \hl{prefer} sparse structures.
