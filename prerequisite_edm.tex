...
\begin{document}
	...
	%
	\author{%\footnotesize
		\alignauthor{Yetian Chen\\
			\affaddr{Department Computer Science}\\
			\affaddr{Iowa State University}\\
			\affaddr{Ames, IA, USA}\\
			\email{\large yetianc@iastate.edu}}
		\alignauthor{Jos\'{e} P. Gonz\'{a}lez-Brenes\\
			\affaddr{Pearson Research \& Innovation Network}\\
			\affaddr{San Diego, CA, USA}\\
			\email{\large jose.gonzalez-brenes@pearson.com}}
		\alignauthor{Jin Tian\\
			\affaddr{Department Computer Science}\\
			\affaddr{Iowa State University}\\
			\affaddr{Ames, IA, USA}\\
			\email{\large jtian@iastate.edu}}	
	}
...
COMMAND relies on a popular machine learning algorithm called \textit{Structural Expectation Maximization} (EM), which to the extent of our knowledge has not been used in educational applications before. 
